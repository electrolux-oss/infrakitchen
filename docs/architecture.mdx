...
![InfraKitchen Architecture](./images/ik-architecture.png)
...
- **Worker** - Execute infrastructure provisioning tasks
...
sequenceDiagram
    ...
    Frontend->>Backend: POST /api/resources/{id}/provision
...
![Backend Modules](./images/ik-modules.png)
