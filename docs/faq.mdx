---
title: FAQ
description: Answers to common questions about InfraKitchen.
sidebar:
  order: 4
---
...
6. Click <kbd>Retry</kbd> to attempt again
...
- Click <kbd>Approve</kbd> in InfraKitchen
...
3. Re-analyze template version
4. Check module folder path is correct
5. Review template version logs
...
- Supports cloud secret managers (AWS Secrets Manager, GCP Secret Manager) and custom encrypted key-value secrets — see [Secrets](secrets/overview)
...
- Open a [GitHub Issue](https://github.com/electrolux-oss/infrakitchen/issues)
