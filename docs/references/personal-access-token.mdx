...
description: Authenticate API and CLI requests as an existing InfraKitchen user with a personal access token.
---
...
<Step title="Open your user page">

Open your own user page in InfraKitchen and find the **Personal Access Tokens** card.

</Step>

<Step title="Create the token">

Click <kbd>Create Token</kbd>, enter a descriptive name, and optionally set an expiration date or use one of the predefined durations.

</Step>

<Step title="Copy and store the token">

Copy the token from the confirmation dialog and store it securely.
...
See [Service Account](../integrations/auth#service-account) for setup instructions.
