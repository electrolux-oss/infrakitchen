...
Revision ID: ad3babc0a5c4
Revises: 6f73b5194d89
Create Date: 2026-04-17 12:41:34.457226
...
revision: str = 'ad3babc0a5c4'
down_revision: Union[str, None] = '6f73b5194d89'
...
def upgrade() -> None:
    ...
    op.create_table('workflow_integrations',
    ...
    sa.ForeignKeyConstraint(['source_code_version_id'], ['source_code_versions.id'], ),
    sa.ForeignKeyConstraint(['template_id'], ['templates.id'], ),
    sa.ForeignKeyConstraint(['workflow_id'], ['workflows.id'], ondelete='CASCADE'),
    sa.PrimaryKeyConstraint('id')
    )
    op.create_table('workflow_step_integrations',
    ...
    op.create_table('workflow_step_parent_resources',
    sa.Column('workflow_step_id', sa.UUID(), nullable=False),
    ...
    op.create_table('workflow_step_secrets',
    sa.Column('workflow_step_id', sa.UUID(), nullable=False),
    sa.Column('secret_id', sa.UUID(), nullable=False),
    sa.ForeignKeyConstraint(['secret_id'], ['secrets.id'], ondelete='CASCADE'),
    sa.ForeignKeyConstraint(['workflow_step_id'], ['workflow_steps.id'], ondelete='CASCADE'),
