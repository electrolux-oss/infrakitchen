...
from application.tools.notification_manager import start_notification_provider_consumer
...
async def lifespan(app: FastAPI):
    ...
    notification_watcher_task = loop.create_task(start_notification_provider_consumer())
