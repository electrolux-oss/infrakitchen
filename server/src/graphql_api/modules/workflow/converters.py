...
def convert_workflow_step(obj: Any, fields: set[str] | None = None) -> WorkflowStepType:
    ...
    parent_res: list[Any] = []
    if fields is None or "parentResourceIds" in fields:
        parent_res = [_convert_resource_shallow(r) for r in getattr(obj, "parent_resource_ids", []) or []]
    ...
    return WorkflowStepType(
        ...
        parent_resource_ids=parent_res,
