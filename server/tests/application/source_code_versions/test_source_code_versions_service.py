...
class TestCreate:
    ...
    async def test_create_success(
        ...
        mock_audit_log_handler.create_log.assert_awaited_once_with(
            created_source_code_version.id,
            mock_user_dto.id,
            ModelActions.CREATE,
            revision_number=created_source_code_version.revision_number,
        )
...
class TestUpdate:
    ...
    async def test_update_success(
        ...
        mock_audit_log_handler.create_log.assert_awaited_once_with(
            updated_source_code.id,
            mock_user_dto.id,
            ModelActions.UPDATE,
            revision_number=updated_source_code.revision_number,
        )
...
class TestPatch:
    ...
    async def test_patch_success_disable_without_dependencies(
        ...
        mock_audit_log_handler.create_log.assert_awaited_once_with(
            ...
            revision_number=source_code_version.revision_number,
        )
