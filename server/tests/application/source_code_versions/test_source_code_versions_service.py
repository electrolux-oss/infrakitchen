...
class TestCreate:
    ...
    async def test_create_success(
        ...
        mock_audit_log_handler.create_log.assert_awaited_once_with(
            created_source_code_version.id, mock_user_dto.id, ModelActions.CREATE, revision_number=ANY
        )
...
class TestPatch:
    ...
    async def test_patch_success_disable_without_dependencies(
        ...
        mock_audit_log_handler.create_log.assert_awaited_once_with(
            source_code_version.id, mock_user_dto.id, ModelActions.DISABLE, revision_number=ANY
        )
